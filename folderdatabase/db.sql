...
--
-- Host: localhost
-- Generation Time: Feb 07, 2018 at 08:39 AM
...
(20, 'Topikal Aplikasi Percobaan A', 'none', 0, 1, 25000, 30000, 70000),
(21, 'Topikal Aplikasi Percobaan B', 'none', 0, 1, 25000, 44000, 70000);
...
(10, '1515572197437', '1516117127920', '14', '[{\"teeth\":85,\"explaination\":\"Belum Erupsi\",\"keterangan\":\"Belum Erupsi Saja\",\"url\":\"../img/small/belum_erupsi.png\",\"$$hashKey\":\"object:20\"}]');
...
INSERT INTO `perawatan` (`id`, `id_pasien`, `id_antrian`, `id_klinik`, `element`, `diagnosa`, `perawatan`, `id_dokter`, `nama_dokter`, `icd10`) VALUES
...
(19, '13', '1515570329227', '1', 'EEE', 'EEE', '[\"Topikal Aplikasi FlourAF RA dan RB\"]', '1', 'dr. Dian Nugraha', 'EEE'),
(20, '13', '1515570329227', '1', 'CC', 'CCCC', '[\"Topikal Aplikasi FlourAF RA dan RB\",\"Topikal Aplikasi Percobaan A\",\"Topikal Aplikasi Percobaan B\"]', '1', 'dr. Dian Nugraha', 'CCC'),
(21, '14', '1515572197437', '1', 'Element Gigi', 'Diagnosa', '[\"Topikal Aplikasi FlourAF RA dan RB\",\"Topikal Aplikasi Percobaan A\"]', '1', 'dr. Dian Nugraha', '11');
...
CREATE TABLE `rm_ekstra_oral` (
  ...
  `keterangan_ekstra_oral` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `rm_ekstra_oral`
--

INSERT INTO `rm_ekstra_oral` (`id`, `id_antrian`, `id_kunjungan`, `id_pasien`, `tonus_bibir`, `tmj`, `kelenjar_limfe`, `kelainan_tmj`, `keterangan_ekstra_oral`) VALUES
(1, '1515570329227 ', '1515570329227', '13', 'hipotonus', 'kelainan', 'teraba', '', 'dadada'),
(2, '1516117127920 ', '1515572197437', '14', 'normal', 'normal', 'tidakteraba', '', 'Coba');
...
CREATE TABLE `rm_jaringan_lunak_mulut` (
  ...
  `id_antrian` varchar(30) NOT NULL,
  `id_pasien` varchar(30) NOT NULL,
  `kebersihan_mulut` varchar(30) NOT NULL,
  `mukosa_bukal` varchar(30) NOT NULL,
  `kelainan_mukosa_bukal` text NOT NULL,
  `mukosa_labial` varchar(30) NOT NULL,
  `kelainan_mukosa_labial` text NOT NULL,
  `frenulum_labial` varchar(30) NOT NULL,
  `kelainan_frenulum_labial` text NOT NULL,
  `lidah` varchar(30) NOT NULL,
  `kelainan_lidah` text NOT NULL,
  `palatum` varchar(30) NOT NULL,
  `kelainan_palatum` text NOT NULL,
  `tonsil` varchar(30) NOT NULL,
  `kelainan_tonsil` text NOT NULL,
  `dasar_mulut` varchar(30) NOT NULL,
  `kelainan_dasar_mulut` text NOT NULL,
  `gingiva` varchar(30) NOT NULL,
  `kelainan_gingiva` text NOT NULL,
  `keterangan_jaringan_lunak_mulut` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `rm_jaringan_lunak_mulut`
--

INSERT INTO `rm_jaringan_lunak_mulut` (`id`, `id_kunjungan`, `id_antrian`, `id_pasien`, `kebersihan_mulut`, `mukosa_bukal`, `kelainan_mukosa_bukal`, `mukosa_labial`, `kelainan_mukosa_labial`, `frenulum_labial`, `kelainan_frenulum_labial`, `lidah`, `kelainan_lidah`, `palatum`, `kelainan_palatum`, `tonsil`, `kelainan_tonsil`, `dasar_mulut`, `kelainan_dasar_mulut`, `gingiva`, `kelainan_gingiva`, `keterangan_jaringan_lunak_mulut`) VALUES
(6, '1515572197437', '1516117127920', '14', 'baik', 'normal', '', 'normal', '', 'normal', '', 'normal', '', 'normal', '', 'normal', '', 'normal', '', 'normal', '', 'Peta mukosa');
...
(10, '1515570329227', '1515570329227 ', '13', 1, 'AB', 0, 'C', 1, 'V', 1, 'G', 1, 'G', 1, 'V', 1, 'VVV', 1, 'TVs'),
(11, '1515572197437', '1516117127920 ', '14', 1, 'Coba', 0, '', 0, '', 1, 'Coba', 0, '', 0, '', 0, '', 0, '');
...
(15, '1515572197437', '1516117127920', 2, 'Dedi', 1, 14, '2'),
...
(30, ' 14', 'Martin Sinambela', '1515572197437', '', 'Topikal Aplikasi FlourAF RA dan RB', '0', '25000', '1'),
(31, ' 14', 'Martin Sinambela', '1515572197437', '', 'Topikal Aplikasi Percobaan A', '0', '30000', '1');

-- --------------------------------------------------------

--
-- Table structure for table `tabel_obat_invoice`
--

CREATE TABLE `tabel_obat_invoice` (
  `id` int(10) NOT NULL,
  `id_pasien` varchar(10) NOT NULL,
  `id_kunjungan` varchar(200) NOT NULL,
...
--
-- Dumping data for table `tabel_obat_invoice`
--

INSERT INTO `tabel_obat_invoice` (`id`, `id_pasien`, `id_kunjungan`, `id_obat`, `nama_obat`, `satuan`, `quantity`, `harga`, `tanggal`) VALUES
(3, '14', '1515572197437', '20', 'Panadol', 'Botol 500 Ml', '2', '300000', '2018-01-31'),
(4, '14', '1515572197437', '21', 'Paracetamol', 'Papan', '1', '2000000', '2018-01-31'),
(5, '14', '1515572197437', '22', 'Alkohol', 'Liter', '4', '5000000', '2018-01-31');
...
(21, ' 14', 'Martin Sinambela', '1515572197437', '', '1', 'Paracetamol', 'Papan', '1', '2000000', '1'),
(22, ' 14', 'Martin Sinambela', '1515572197437', '', '4', 'Alkohol', 'Liter', '4', '5000000', '1');
...
--
-- Indexes for table `rm_ekstra_oral`
--
ALTER TABLE `rm_ekstra_oral`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tabel_obat_invoice`
--
ALTER TABLE `tabel_obat_invoice`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `rm_ekstra_oral`
--
ALTER TABLE `rm_ekstra_oral`
...
--
-- AUTO_INCREMENT for table `tabel_obat_invoice`
--
ALTER TABLE `tabel_obat_invoice`
