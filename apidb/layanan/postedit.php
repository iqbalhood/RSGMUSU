...
if(isset($postdata) && !empty($postdata))
{
    ...
    $sql = "UPDATE `data_layanan` SET `layanan` = '$newName',`bahan` = '$newBahan' ,`harga_bahan` = '$newHargabahan',`harga_koas` = '$newHargakoas',`harga_ppdgs` = '$newHargappdgs',`harga_drg` = '$newHargadrg',`harga_drgsp` = '$newHargadrgsp' WHERE `data_layanan`.`id` = $newId;";
