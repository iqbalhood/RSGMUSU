...
$db = new DB_CONNECT();
	...
	$result = mysql_query("SELECT 	tabel_kunjugan.id_kunjungan,
                                ...
                                WHERE tabel_kunjugan.status = '2' AND tabel_kunjugan.status_pembayaran = '1' AND tabel_kunjugan.tanggal_kunjungan = '$dateToday' ORDER BY tabel_kunjugan.id_kunjungan DESC ") or die(mysql_error());
		// cek
